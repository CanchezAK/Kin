...
#define SSD1306_CMD_ACCESS() HAL_GPIO_WritePin(SPI_DC_GPIO_Port, SPI_DC_Pin, GPIO_PIN_RESET)
#define SSD1306_DISP_ACCESS() HAL_GPIO_WritePin(SPI_DC_GPIO_Port, SPI_DC_Pin, GPIO_PIN_SET)

/* Reset pin control */
#define SSD1306_RESET_HIGH() HAL_GPIO_WritePin(SPI_Reset_GPIO_Port, SPI_Reset_Pin, GPIO_PIN_SET)
#define SSD1306_RESET_LOW() HAL_GPIO_WritePin(SPI_Reset_GPIO_Port, SPI_Reset_Pin, GPIO_PIN_RESET)
