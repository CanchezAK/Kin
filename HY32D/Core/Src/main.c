...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, RS_Pin|LCD_CS_Pin|RD_Pin|WR_Pin
                          |RST_Pin|D15_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, D0_Pin|D1_Pin|D2_Pin|D10_Pin
                          |D11_Pin|D12_Pin|D13_Pin|D14_Pin
                          |D3_Pin|D4_Pin|D5_Pin|D6_Pin
                          |D7_Pin|D8_Pin|D9_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : RS_Pin LCD_CS_Pin RD_Pin WR_Pin
                           RST_Pin D15_Pin */
  GPIO_InitStruct.Pin = RS_Pin|LCD_CS_Pin|RD_Pin|WR_Pin
                          |RST_Pin|D15_Pin;
