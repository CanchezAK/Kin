/*
  ILI9486.h - Multi-Platform library support for Color TFT LCD Boards
...
class ILI9486
{
	public:
		ILI9486();
		ILI9486(int RS, int WR, int CS, int RST, int RD=0);
...
/*
	...
	that might need access to the lower level functions of ILI9486.
